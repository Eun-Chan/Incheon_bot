...
public class FoodCommand5 implements ICommand {

	@Override
	public String execute() {
		// TODO Auto-generated method stub

		System.out.println("사범대 식당 command.execute()");
		
		String url = "http://www.inu.ac.kr/com/cop/mainWork/foodList5.do?siteId=inu&id=inu_050110060000";
		...
		//식당 이름
		Element elem1 = doc.select("ul.subTab li a").get(4);
